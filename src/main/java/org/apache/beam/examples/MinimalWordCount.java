...
public class MinimalWordCount {
  ...
  public static void main(String[] args) {
    ...
    p.apply(FileIO.match().filepattern("/home/raphaelmaciel/Downloads/DATAHUB_CDM_CUSTOMER_V2_LGPD.zip"))
                    ...
                    ParDo.of(
                            new DoFn<FileIO.ReadableFile, String>() {
                              ...
                              public void process(@Element FileIO.ReadableFile file) {
                                ...
                                System.out.println("##########################################################################################");
                                System.out.println(file.getMetadata().resourceId().getFilename());
                                System.out.println("##########################################################################################");
                              }
                            }));
